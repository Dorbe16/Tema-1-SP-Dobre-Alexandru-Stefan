  ...
  subplot(3,1,1),plot(t,x,'.-'),xlabel('Timp [s]'),ylabel('Amplitudine'),title('multinivel a'),grid; %afisam graficul x=f(t), in prima minifereastra
  
  [x,t] = func(0.02,0.25,8,[-1,1]);
  subplot(3,1,2),plot(t,x,'.-'),xlabel('Timp [s]'),ylabel('Amplitudine'),grid; %afisam graficul x=f(t), in a doua minifereastra
  
  [x,t] = func(0.002,0.25,8,[-1,1]);
  subplot(3,1,3),plot(t,x,'.-'),xlabel('Timp [s]'),ylabel('Amplitudine'),grid; %afisam graficul x=f(t), in a treia minifereastra
