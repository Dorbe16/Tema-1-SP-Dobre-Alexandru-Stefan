...
x = 1.5*sawtooth(2 * pi * 0.2 * t , 0.5) - 0.5; % 0.5(al doilea argument al functiei sawtooth) specifica o forma simetrica a semnalului triunghiular. 
...
x = 1.5*sawtooth(2 * pi * 0.2 * t , 0.5) - 0.5; 
